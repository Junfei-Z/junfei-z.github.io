        ...
        <ul class="news-list">
          ...
          <li class="news-item itm-paper">
            ...
            <div class="news-body">
              ...
              <p class="news-title">论文「Trains but Doesn’t Learn: A Post-Training Delivery Benchmark for LLM Agents as Forward-Deployed Engineers」被 <em>The 2026 Conference on Empirical Methods in Natural Language Processing (EMNLP 2026)</em> 录用。</p>
              <p class="news-meta">合作者：<b>Weihang Ding</b>。特别感谢 Weihang 在这项工作中的辛勤付出。</p>
            </div>
          </li>
