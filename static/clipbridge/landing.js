(() => {
  ...
  const EN = {
    ...
    demoKicker: "30-second product demo",
    demoTitle: "See the complete handoff before choosing a workflow.",
    demoBody: "From nearby text and file transfer to carrying unfinished Agent work to another computer through GitHub.",
    demoFactsLabel: "Video details",
    demoFactDuration: "30 seconds",
    demoFactAudio: "English narration",
    demoFactCaptions: "On-screen captions",
    demoVideoLabel: "ClipBridge 30-second product demo video",
    demoFallback: "Your browser cannot play this video.",
    demoDownload: "Download the video",
    demoCaption: "ClipBridge in 30 seconds",
    demoCredit: "Built with GMI Cloud",
